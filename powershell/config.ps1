function ShowDialog($FilePath)
{
    ...
    $Vcloud_LinkLabel.text           = "Click here to copy the URL for a Google Doc containing these values. Paste in an S1-linked browser. These values MUST match the values in the Google Doc!"
